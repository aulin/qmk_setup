...
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL, KC_LGUI, KC_NUBS, KC_LALT, MO(_LOWER), KC_SPC, KC_SPC, MO(_RAISE), KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_LOWER] = LAYOUT_ortho_4x12(
    KC_BSLS, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,     KC_CIRC,     KC_AMPR,       KC_ASTR,    KC_LPRN,    KC_RPRN, KC_TRNS,
